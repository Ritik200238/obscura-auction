export const config = {
  ...
  programId: 'obscura_core_v2.aleo',                        // Core: auction lifecycle + bidding
  settleProgramId: 'obscura_settle_v2.aleo',                // Settle: ALEO token paths
  settleStableProgramId: 'obscura_settle_stable_v2.aleo',   // Settle: USDCx + USAD paths
